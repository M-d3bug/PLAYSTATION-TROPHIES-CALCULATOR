const trophyPoints = {
    ...
    function updateData() {
      ...
      const system = 'current'; // Removed the loop and set the system to 'current'
        ...
        if (pointsNeeded > 0) {
          ...
          desiredLevelResultsDiv.innerHTML = `
            ...
            <p class="info-text">Trophies needed: 
              ...
              <span class="gold-text"><strong>gold</strong></span>: ${trophiesNeeded.gold} or 
              <span class="platinum-text"><strong>platinum</strong></span>: ${trophiesNeeded.platinum}
            </p>
